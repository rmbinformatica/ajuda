...
* [Como desativar a expiração de senha dda conta de usuário local do Microsoft Windows](sistemas-operacionais/microsoft-windows/desativar-expiracao-senha-windows)

## Tira-dúvidas

* [Para que serve a opção criar arquivo sólido no WinRAR?](duvidas/para-que-serve-opcao-arquivo-solido-winrar)
* [Para que serve a opção criar bloquear arquivo no WinRAR?](duvidas/para-que-serve-opcao-bloquear-arquivo-winrar)
